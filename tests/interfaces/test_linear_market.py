...
# OBSERVATION
def test_observation_on_step_buy(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    (observation, reward, done, info) = mkt.step(0)
...
# REWARD
def test_reward_on_step_buy(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    (observation, reward, done, info) = mkt.step(0)
    assert reward == mkt.fee - mkt.data[-2]

def test_reward_on_step_sell(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    price = mkt.data[-2]
    mkt.position = 1
...
def test_reward_on_step_no_act(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
...
# POSITION
def test_position_on_step_buy(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.money = 31.4
    price = mkt.data[-2]
...
def test_position_on_step_sell(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.position = 31.4
    mkt.money = 3.14
...
def test_position_on_step_no_act(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.money = 3.14
    mkt.position = 31.4
...
# MONEY
def test_money_on_step_buy(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.money = 31.4
    (observation, reward, done, info) = mkt.step(0)
...
def test_money_on_step_sell(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.position = 31.4
    mkt.money = 3.14
...
def test_money_on_step_no_act(create_i_linear_market_env):
    mkt = create_i_linear_market_env(TEST_INC_PARAMS)
    mkt.idx = 0
    mkt.money = 3.14
    (observation, reward, done, info) = mkt.step(2)
